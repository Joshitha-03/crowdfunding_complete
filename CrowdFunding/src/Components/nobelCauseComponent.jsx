  ...
  return (
    <React.Fragment>
      <div className={`col-12 m-auto ${styles.container}`}>
        ...
        "Join hands to make a difference! Every contribution helps bring hope, support, and resources to those in need. Together, we can create a brighter future for communities in need. Be the change—start today!"
        </p>
